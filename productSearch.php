	...
	<body class="landing">
			...
			<header id="header">
				...
				<nav id="nav">
					<ul>
						...
						<li><a href="elements.html">Review</a></li>
					</ul>
				</nav>
			</header>
		...
		<!-- Footer -->
			...
			<div class="footer-left">
				<h3 style="font-family: 'Times New Roman', cursive;">OUR CIRCLE &copy; </h3>
				<div class="logo">
					<a href="index.php"><img src="images/logo.png" width="200px"></a>
				</div>
				<p style="font-size:20px;color:white">we live <br />& we are humans !!!</p>
				<br />
			</div>
			...
			<div class="footer-center">
				<div>
					...
					<p style="font-size:20px">ATME College Of Engineering<span>MYSORE</span></p>
				</div>
				<div>
					<i class="fa fa-phone"></i>
					<p style="font-size:20px">660219525</p>
				</div>
				<div>
					<i class="fa fa-envelope"></i>
					<p style="font-size:20px"><a href="mailto:artistkattawce@gmail.com" style="color:white">rajeshsg261@gmail.com</a></p>
				</div>
			</div>

			<div class="footer-right">
				<p class="footer-company-about" style="color:white">
					<span style="font-size:20px"><b>About OUR CIRCLE</b></span>
					OUR Circle is a club established by the students of ATME College of Engineering, MYSORE
