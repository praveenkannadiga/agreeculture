	...
	?>
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agriculture farm house<span>karnataka</span></p>
			</div>
			<div>
				<i class="fa fa-phone"></i>
				<p style="font-size:20px">8431172372</p>
			</div>
			<div>
				<i class="fa fa-envelope"></i>
				<p style="font-size:20px"><a href="mailto:agroculture@gmail.com" style="color:white">praveenkannadiga888@gmail.com</a></p>
			</div>
		</div>
		...
		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				...
				we provide e-commerce for your products,experience easy marketting
				we are with you .lets grow together. 
